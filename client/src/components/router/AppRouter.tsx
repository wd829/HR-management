...
import SettingsDataPage from '@app/pages/SettingDataPage';
import { useAppSelector } from '@app/hooks/reduxHooks';
import { UserModel } from '@app/domain/UserModel';
import RequireAdminRole from './RequireAdminRole';
import RequireTeamLeaderRole from './RequireTeamLeaderRole';

const DataTablesPage = React.lazy(() => import('@app/pages/DataTablesPage'));

//User and Daily and Team Report
const UsersPage = React.lazy(() => import('@app/pages/UsersPage'));
const NewReportPage = React.lazy(() => import('@app/pages/NewReportPage'));
const PersonalReportsPage = React.lazy(() => import('@app/pages/ReportPage'));
const TeamReportPage = React.lazy(() => import('@app/pages/TeamReportPage'));
const NewScorePage = React.lazy(() => import('@app/pages/NewScorePage'))
const ViewScorePage = React.lazy(() => import('@app/pages/ViewScorePage'))
const Settingspage = React.lazy(() => import('@app/pages/SettingDataPage'));
const UserListPage = React.lazy(() => import('@app/pages/UserListPage'))
const DashboardPage = React.lazy(() => import('@app/pages/DashboardPage'))
const ViewScoreAllPage = React.lazy(() => import('@app/pages/ViewAllProfilt'));
...
const NftDashboard = withLoading(ChartsPage);
...
const NewReport = withLoading(NewReportPage);
const PersonalReports = withLoading(PersonalReportsPage);
const TeamReports = withLoading(TeamReportPage);
const Settings = withLoading(Settingspage);
const NewScore = withLoading(NewScorePage);
const ViewScore = withLoading(ViewScorePage);
const UserList = withLoading(UserListPage);
const Dashboard = withLoading(DashboardPage);
const ViewAllScore = withLoading(ViewScoreAllPage);
...
const Notifications = withLoading(NotificationPage);
      ...
      <Routes>
        <Route path={DASHBOARD_PATH} element={protectedLayout}>
          ...
          <Route path="/personal">
            ...
            <Route path="view" element={<PersonalReports />} />
          </Route>
          ...
          {/* <Route path="team"
            element={<RequireTeamLeaderRole>
              <TeamReport />
            </RequireTeamLeaderRole>} /> */}
          {/* ----------END------------ */}
          <Route path="charts" element={<Charts />} />

          <Route path="team" element={<Leaflet />} />
